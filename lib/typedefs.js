 ...
 *
 * So, all public types that are useful to the end user should be declared
 * here and imported from here into modules where required.
 */
...
/**
 * HACK: this is required for JS type checking to work in VSCode
 */
module.exports = {};
