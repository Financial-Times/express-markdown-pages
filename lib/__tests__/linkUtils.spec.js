...
describe('lib/linkUtils', () => {
	...
	describe('.createRedirectSlug()', () => {
		it('resolves the path between two internal pages', () => {
			const resultA = subject.createRedirectSlug(
				'docs/Section 1/Page 1.md',
				'../Section 2/Page 2.md',
			);

			expect(resultA).toBe('docs/section-2/page-2');

			const resultB = subject.createRedirectSlug(
				'docs/Section 1/Page 1.md',
				'Page 2.md',
			);

			expect(resultB).toBe('docs/section-1/page-2');
		});
	});
});
