...
/**
 * Is internal
 * @description Tests if a link is not an absolute URL or path
 * @param {String} href
 * @returns {Boolean}
 */
function isInternal(href) {
	return typeof href === 'string' && !IS_ABSOLUTE.test(href);
}
...
function isInternalLink(href) {
	return isInternal(href) && href.endsWith('.md');
}
 ...
 * @returns {Boolean}
 */
function isInternalImage(href) {
	return isInternal(href) && /\.(png|gif|jpg|svg|webp)$/.test(href);
}
